              ...
              : rows.map((r) => (
                  <TableRow key={r.id} className="hover:bg-gray-50">
                    ...
                    <TableCell className="max-w-[160px]">
                      <ProviderBadge name={r.cloud_primary_provider} isMulti={r.cloud_is_multi} providers={r.cloud_providers} isNotApplicable={r.cloud_not_applicable} type="cloud" className="whitespace-normal w-full h-auto" />
                    </TableCell>
                    ...
                    <TableCell className="max-w-[160px]">
                      <ProviderBadge name={r.ai_primary_provider} isMulti={r.ai_is_multi} providers={r.ai_providers} isNotApplicable={r.ai_not_applicable} type="ai" className="whitespace-normal w-full h-auto" />
                    </TableCell>
