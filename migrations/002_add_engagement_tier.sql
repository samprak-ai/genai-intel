-- Migration: Add engagement tier columns to attribution_snapshots
...
-- ============================================================================
-- Step 2: Update latest_attributions view to include engagement columns.
...
WHERE table_name = 'latest_attributions'
  AND column_name IN ('engagement_tier', 'engagement_tier_label', 'engagement_tier_rationale', 'tier_last_calculated')
